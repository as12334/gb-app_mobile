package so.wwb.gamebox.mobile.transfer.form;
...
import so.wwb.gamebox.mobile.transfer.controller.TransferController;
...
//region your codes 1
@Comment("转账验证")
public class PlayerTransferForm implements IForm {
//endregion your codes 1
    ...
    @Remote(message = "fund.transferForm.transferAmountCheck", checkClass = TransferController.class, checkMethod = "checkTransferAmount", additionalProperties = {"transferOut"})
