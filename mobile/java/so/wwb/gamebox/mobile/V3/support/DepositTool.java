...
public class DepositTool {
    ...
    public static IPlayerRechargeService playerRechargeService() {
     ...
     * @return
     */
    private static long getDepositFeeSchemaCountInTime(RechargeFeeSchema schema, boolean isFee, boolean isReturnFee) {
     ...
     * @return
     */
    public static RechargeFeeSchemaVo calculateFeeSchema(double rechargeAmount, String account) {
        //查询手续费方案
     ...
     * @return
     */
    public static double calculateFeeSchemaAndRank(PlayerRank rank, double rechargeAmount, String account) {
