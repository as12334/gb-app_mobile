...
public class MineController{
    ...
    public String getFund(HttpServletRequest request) {
        ...
        userInfo.put("avatarUrl", ImageTag.getThumbPathWithDefault(SessionManager.getDomain(request), StringEscapeTool.unescapeHtml4(sysUser.getAvatarUrl()), 46, 46, null));
