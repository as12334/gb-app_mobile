...
<div class="gb-withdraw-box pro-window">
    <div class="cont">
        ...
        <div class="pro-btn" style="text-align: center;">
            <a data-rel='{"opType":"function","target":"confirmSale","id":"confirmSale","saleUrl":"${root}/wallet/deposit/digiccy/saveSale.html"}' class="next-btn" id="confirmSale" >${views.themes_auto['确认']}</a>
        </div>
