        ...
        <div class="mui-scroll-wrapper">
            <div class="mui-scroll">
                <div class="pro_list_item">
                    <label for="pro_item"><div class="text">${views.deposit_auto['不参与优惠']}</div><input name="activityId" type="radio" value="" checked="checked"/></label>
                </div>
                <c:forEach items="${sales}" varStatus="vs" var="i">
                    <c:if test="${i.preferential}">
                        <div class="pro_list_item">
                            <label for="pro_item"><div class="text">${i.activityName}</div><input name="activityId" type="radio" value="${i.id}"/></label>
                        </div>
                    </c:if>
                </c:forEach>
            </div>
