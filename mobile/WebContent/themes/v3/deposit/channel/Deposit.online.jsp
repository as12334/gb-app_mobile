    ...
    <c:when test="${fn:length(accounts)>0}">
        ...
        <div class="pay_mone">
            ...
            <div class="depo_row">
                ...
                <%--<div class="input_dp_num"><input id="result.rechargeAmount" name="result.rechargeAmount" type="text" placeholder="${siteCurrencySign}${soulFn:formatCurrency(onlinePayMin)}~${siteCurrencySign}${soulFn:formatCurrency(onlinePayMax)}"/></div>--%>
                <div class="input_dp_num"><input id="result.rechargeAmount" name="result.rechargeAmount" type="text" placeholder="${soulFn:formatCurrency(onlinePayMin)} ~ ${soulFn:formatCurrency(onlinePayMax)}"/></div>
