        ...
        <div class="mui-scroll">
            ...
            <div class="person-info">
                ...
                <div class="login" style="display: none;">
                    ...
                    <p></p>
                    <soul:button target="goTab" skip="4" dataHref="/mine/index.html?channel=mine" isLeft="true" text="个人中心" opType="function" cssClass="mui-btn mui-btn-success btn-person" tag="button"/>
                </div>
            </div>
            <!--side-nav-->
            <div class="side-nav">
