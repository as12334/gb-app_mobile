        ...
        <div class="mui-scroll">
            ...
            <div class="side-nav">
                <ul class="mui-list-unstyled">
                    ...
                    <li class="active home"><soul:button target="goTab" isLeft="true" skip="2" text="首页" dataHref="/mainIndex.html" opType="function"/></li>
                    <li class="pro"><soul:button target="goTab" text="优惠活动" isLeft="true" skip="1" dataHref="/discounts/index.html?skip=1" opType="function" cssClass=""/></li>
