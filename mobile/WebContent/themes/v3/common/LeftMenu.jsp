        ...
        <div class="mui-scroll">
            ...
            <div class="side-nav">
                <ul class="mui-list-unstyled">
                    ...
                    <li class="deposit"><soul:button target="goTab" skip="0" dataHref="/wallet/deposit/index.html" text="账户存款" opType="function"/></li>
                    ...
                    <li class="service"><soul:button target="goTab" text="在线客服" skip="3" dataHref="" opType="function"/></li>
