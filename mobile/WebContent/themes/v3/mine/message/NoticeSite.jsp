...
<div class="mui-row">
    <div class="gb-noticetabs">
        <div id="" class="mui-segmented-control">
            <a href="#" data-href="noticeSite1" data-rel='{"target":"segmentedControl2","opType":"function"}'
               class="mui-control-item">系统消息</a>
            <a href="#" data-href="noticeSite2" data-rel='{"target":"segmentedControl2","opType":"function"}'
               class="mui-control-item">我的消息</a>
            <a href="#" data-href="noticeSite3" data-rel='{"target":"segmentedControl2","opType":"function"}'
...
<div id="noticeSite1" class="mui-control-content <c:if test="${empty unReadType || unReadType eq 'sysMessage'}">mui-active</c:if>"
     name="noticeSite">
    <form name="site1">
        <div class="operate-message">
            <p>
