...
<style type="text/css">
    ...
    .header i {
        ...
        width: 44px;
        background: url("${resRoot}/themes/images/icon_close.png") no-repeat center;
...
<div class="header gb-header">
    <i class="close mui-action-back"></i>
            ...
            <c:otherwise>
                <div class="mui-content-padded gb-qr">
                    <c:if test="${os eq 'h5_android' || os eq 'pc'}">
                        ...
                        <div>
                            <a href="${androidUrl}"
                               class="mui-btn mui-btn-primary btn-download">${views.app_auto['下载Android版']}</a>
                        </div>
                    </c:if>
                    <c:if test="${os eq 'ios' || os eq 'pc'}">
                        <div class="qrcode-img"><img src="data:image/png;base64, ${iosQrcode}"/></div>
                        <a href="${iosUrl}"
                           class="mui-btn mui-btn-primary  btn-download">${views.app_auto['下载IOS版']}</a>
                        ...
                        <div class="ios_guide">
                            <div class="column">
                                <p class="small-12 columns center_align"
                                   style="font-size: 16px; margin-bottom: 0;">${views.app_auto['安装APP']}</p>
                            </div>
...
<script>
    $(function () {
        ...
        mui("body").on("tap", "a.ios8", function () {
            $('div#ios8').show();
            $('div#ios9').hide();
        })
