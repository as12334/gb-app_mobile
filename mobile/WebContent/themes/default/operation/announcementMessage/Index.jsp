...
<form method="post" action="${root}/operation/pAnnouncementMessage/messageList.html">
        <div class="notice">
        ...
        <div class="tabmenu tabmenu-2">
            <ul class="tab-2">
                ...
                <li>
                    <a href="/operation/pAnnouncementMessage/advisoryMessage.html" class="current" nav-target="mainFrame">${views.operation_auto['我的消息']}
