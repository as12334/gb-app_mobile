...
<div class="wrap">
    <div class="notice">
        ...
        <div class="path-right"><a class="cursor">${views.operation_auto['消息公告']}</a><span class="arrow">></span>${views.operation_auto['游戏公告']} </div>
    </div>
    <div class="return">
        <a href="/operation/pAnnouncementMessage/gameNotice.html" nav-target="mainFrame" class="btn btn-gray btn-big">${views.operation_auto['返回上一级']}</a>
    </div>
    <!--选项卡-->
    <div class="tabmenu">
        <ul class="tab">
            <li><a href="javascript:void(0)" class="current gameAnn" >${views.operation_auto['游戏公告']}</a></li>
...
<soul:import res="site/operation/message/GameNoticeDetail"/>
