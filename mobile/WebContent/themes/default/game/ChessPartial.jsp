            ...
            <c:forEach var="gi" items="${gameI18n}">
                <c:if test="${g.gameId == gi.key}">
                    <div class="mui-col-xs-3">
                        ...
                        <a class="item ${g.apiId eq 10?'_api':'_game'}" data-api-type-id="5" data-api-id="${g.apiId}" <c:if test="${g.apiId!=10}">data-game-id="${g.gameId}" data-game-code="${g.code}"</c:if>data-status="${g.status}">
                            <p class="m-b-0">
